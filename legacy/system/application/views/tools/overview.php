    ...
    <div class="AccountLeftside">
        ...
        <div id="RtoolsNav" style="border:0px solid #090;float:left;margin-left:18px;width:300px;">
            	 ...
            	 <div class="cat-bg" style="width:300px;float:left;border:0px solid #F00;">
 								...
 								<div class="innerbox"> 
                                <table><tbody><tr><td rowspan=2 width=30><img src="/images/icons/LinkChain.gif"></td><td>Share Your Unique Referral Link</td></tr><tr><td><input type=text value="<?php echo base_url(); ?>{alias}"/></td><td></td></tr></tbody></table>
                                                
                                         <table><tr><td  width=30><img src="images/icons/email.gif"></td><td>Email it<br><a onclick="$.get($(this).attr('href'),function(data){document.location=data;});return false;" href='/tools/email_personal/{alias}'>Personal</a></td><td>Email your friends and watch your cash back grow!</td></tr><tr><td rowspan=2 width=30><img src="images/icons/email.gif"></td><td>Email it<br><a onclick="$.get($(this).attr('href'),function(data){document.location=data;});return false;" href='/tools/email_business/{alias}'>Business</a></td><td>
Email your favorite websites and watch your cash back grow!</td></tr></table>
                                         
                                        
                                     <table><tbody><tr><td rowspan=2 width=30><img src="/images/icons/pen.gif"></td><td>Add a signature to your emails and forum posts</td></tr><tr><td>
...
<LABEL for=check><p class="small">Forum Signature</LABEL></td><td></td></tr></tbody></table></div>
                                    ...
                                    <div class="RToolsTxt"><p>Build your cash back through social networks. Post a one time message or automatically let your social network know when you save money with BeeSavy!</div>
         		                    <div class="innerbox">
				<table><tr><td width=25 align=left><img src="/images/facebooktop.gif" width=31 height=31></td><td>Share it on Facebook</td></tr></table>
    ...
    <?php if($facebook_auto) echo"CHECKED"?> type=checkbox name=value></td><td>Automatically post cash back messages to your Facebook wall.</td></tr></table>
				...
				<table border=0><tr><td width=25 align=left><img src="/images/twittertop.gif" width=31 height=31></td><td>Tweet it</td></tr></table>
	<FORM id=changeNewsletterForm method=post name=changeNewsletterForm action=/tools/set_setting>
