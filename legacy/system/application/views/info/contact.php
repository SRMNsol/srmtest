        ...
        <form id="contactForm" name="contactForm" action="/info/contact_submit" method="post" enctype="application/x-www-form-urlencoded">
            <dl style="margin-left:30px;float:left;">
                <table width=460 border=0>
                    <tr height=30>
                        <td align=right><font size=2><strong>Your Name :&nbsp;&nbsp;</strong></font></td>
                        <td><DD id="name-element" ><INPUT id=name class=optional type=text name=name></DD></td>
                    </tr>
                    <tr>
                        <td align=right height=30><font size=2><strong>Email Address :&nbsp;&nbsp;</strong> </font></td>
                        <td><DD id=email-element><INPUT id=email class="required email" type=text name=email></DD></td>
                    </tr>
                    <tr>
                        <td height=30 align=right><dt id="subject-label"><label for="subject" class="required">Subject</label></dt></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <dd id="store_name-element" style="display: block; ">
                    ...
                    <tr>
                        <td><dt id="order_number-label" style="display: block; "><label for="order_number" class="optional">Order Number : </label></dt></td>
                        <td><dd id="order_number-element" style="display: block; "><input type="text" name="order_number" id="order_number" value="" class="required"></dd></td>
                    </tr>
                    <tr>
                        <td><dt id="purchase_subtotal-label" style="display: block; "><label for="purchase_subtotal" class="optional">Purchase Subtotal :</label></dt></td>
                        <td><dd id="purchase_subtotal-element" style="display: block; "><input type="text" name="purchase_subtotal" id="purchase_subtotal" value="" class="required"> (excluding tax, shipping, coupons)</dd></td>
                    </tr>
                    <tr>
                        <td><dt id="click_id-label" style="display: block; "><label for="click_id" class="optional">Approx. Purchase Date</label></dt><dt id="month-label" style="display: none; "><label for="month" class="optional">Purchase Date</label></dt></td>
                        <td>
                            ...
                            <dd id="year-element" style="display: none; ">
                                <select name="year" id="year">
                                    <option value="<?php echo date("Y") ?>" label="<?php echo date("Y") ?>"><?php echo date("Y") ?></option>
                                    <option value="<?php echo date("Y") - 1 ?>" label="<?php echo date("Y") -1 ?>"><?php echo date("Y") -1 ?></option>
                                </select>
                            </dd>
                        </td>
                    </tr>
                    <tr>
                        <td><dt id="message-label"><label for="message" class="required">Message</label></dt></td>
                        <td><dd id="message-element"><textarea name="message" id="message" class="required" rows="8" cols="40"></textarea></dd></td>
                    </tr>
                    <tr>
                        <td><dt id="message-label"><label for="message" class="required">Captcha</label></dt></td>
                        <td>{recaptcha_html}</td>
                    </tr>
                    <tr>
                        <td colspan=2>
                            <dt id="submit-label">&nbsp;</dt>
                            <DD><div class="SendMessage"><div class="BtnSendMessageBg BtnSendMessage"><INPUT type="submit" name="" value=""/></div></div></dd>
                        </td>
                    </tr>
                </table>
