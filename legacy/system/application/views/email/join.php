...
<li style="font-size:10px;font-family:arial;font-weight:normal;	list-style: url(<?php echo s3path('/images/transfer-arrow.gif') ?>) outside;margin-left:20px;"><p style="margin-top:10px;margin-left:10px;margin-bottom:10px;font-size:15px;font-family:arial;color:#000;">Find hundreds of exclusive <strong>coupons</strong></p></li>
</ul>
