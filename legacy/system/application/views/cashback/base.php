...
<!-- content -->
	...
	<div id="pageTitle">
		...
		<div id="titleNav" class="large">
			<a href="/cashback" id="active">Cash Back Summary</a>
...
<div class="merchantView_Width">
	<div >
		...
		if($type=='personal'){
			...
			<li><a <?php echo $activetab[0]?> href="/cashback"><font class="tabstext">All</font></a></li>
			<li><a <?php echo $activetab[1]?> href="/cashback/personal">Personal</a></li>
			<li><a <?php echo $activetab[2]?> href="/cashback/referral">Referral</a></li>
		</ul>
	</div>
