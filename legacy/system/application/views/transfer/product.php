        ...
        <div style="margin:auto; width:602px; display:inline-block; vertical-align:top;">
            <div id="transfer" style="margin:0;">
                ...
                <div id="productThumb" class="thumb">
                    <img class="cdn-image" src="{thumb}" onload="
                        var width = 100;
                        var height = 32;
                ...
                <div id="equation">
                    ...
                    <dl>
                        ...
                        <dd>${coupon_discount}</dd>
                    </dl>
                    <dl>
                        <dt>CASH BACK</dt>
                        <dd>${cashback_amount}</dd>
                    </dl>
                    <dl style="border-right: medium none;">
                        <dt class="BeesavyPrice">BEESAVY&nbsp;&nbsp;PRICE</dt>
                        <dd class="BeesavyPrice">${final_amount}</dd>
                    </dl>
                    <div class="priceMessage">Store Price is the price you will see at checkout</div>
                </div>
