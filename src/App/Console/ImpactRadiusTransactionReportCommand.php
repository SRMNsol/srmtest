...
class ImpactRadiusTransactionReportCommand extends Command
{
    public function configure()
    {
        $this
            ->setName('impactradius:transactions')
            ->setDescription('Download Impact Radius transactions')
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $report = $app['impactradius_report'];
