<div id="nav">
              ...
              <div id="nav-ShopByCatagory-bt"><img src="/images/nav_catagoryBt.jpg" width="140" height="42" alt="** PLEASE DESCRIBE THIS IMAGE **" onclick="$('#catDropdown1').slideToggle();"/></div>
